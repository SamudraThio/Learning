...
namespace progex03
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Invalid input - input string was not an integer.");
            }
            catch (InputOutofBounds)
            {
                Console.WriteLine("Invalue input - input string needs to be greater than 0.");
            }
            ...
            catch (NoSqRtNegatives)
            {
                Console.WriteLine("You can't take the square root of a negative number, at least until we implement imaginary numbers.");
            }
            finally
            {
                Console.WriteLine("This program has been terminated.");
            }
        }
        ...
        private static void QuadraticEquation()
        {
            checked
            {
                ...
                if ((Math.Pow(intBVariable, 2) - 4 * intAVariable * intCVariable) < 0)
                {
                    throw new NoSqRtNegatives();
                }
    ...
    class NoSqRtNegatives : Exception
    {
        public NoSqRtNegatives()
        {
