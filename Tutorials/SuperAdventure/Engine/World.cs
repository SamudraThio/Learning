...
namespace Engine
{
    class World
    {
        ...
        private static void PopulateMonsters()
        {
            ...
            Monster snake = new Monster(MONSTER_ID_SNAKE, "Snake", 5, 4, 10, 3, 3);
        ...
        private static void PopulateLocations()
        {
            ...
            Location alchemistHut = new Location(LOCATION_ID_ALCHEMIST_HUT, "Alchemist's hut", "There are many strange plants on the shalves.");
